...
const STRINGS: Record<string, [string, string, string]> = {
  ...
  'feed.forYou': ['Ideal for you', 'Ideal para ti', 'Idéal pour vous'],
  'feed.forYouSub': ['Picked for your taste', 'Elegido para tu paladar', 'Choisi pour votre palais'],
  'feed.topPick': ['Top pick', 'La mejor opción', 'Le meilleur choix'],
  'feed.forYouScore': ['for you', 'para ti', 'pour vous'],
  'rec.taste': ['Right up your {x} alley', 'Va con tu gusto por {x}', 'Pile dans votre goût {x}'],
  'rec.beloved': ['Beloved by thousands', 'Adorado por miles', 'Adoré par des milliers'],
  'rec.gem': ['A hidden gem', 'Una joya escondida', 'Une pépite'],
  'rec.topRated': ['Top-rated', 'Muy bien valorado', 'Très bien noté'],
  'rec.open': ['Open now', 'Abierto ahora', 'Ouvert maintenant'],
  'rec.solid': ['Solid choice', 'Buena opción', 'Valeur sûre'],
  ...
  'you.closest': ['Palates like yours', 'Paladares como el tuyo', 'Palais comme le vôtre'],
  'you.shareCard': ['Share taste card', 'Compartir tarjeta', 'Partager la carte'],
  'foodie.title': ['Taste profile', 'Perfil de sabor', 'Profil de goût'],
  'foodie.match': ['Palate match', 'Afinidad de paladar', 'Affinité de palais'],
  'foodie.placesYear': ['places this year', 'lugares este año', 'lieux cette année'],
  'foodie.follow': ['Follow', 'Seguir', 'Suivre'],
  'foodie.following': ['Following', 'Siguiendo', 'Suivi'],
  'foodie.matchShort': ['match', 'afinidad', 'affinité'],
  'tasteCard.title': ['Taste passport', 'Pasaporte de sabor', 'Passeport de goût'],
  'tasteCard.share': ['Share my taste', 'Compartir mi paladar', 'Partager mon goût'],
  'tasteCard.copied': ['Copied ✓', 'Copiado ✓', 'Copié ✓'],
